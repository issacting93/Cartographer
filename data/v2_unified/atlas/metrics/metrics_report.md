...
**Conversations Analyzed:** 2577
**Total Constraints Tracked:** 0
**Total Violations Detected:** 535
**Total Repairs Attempted:** 107

## Overall Metrics

| Metric | Value |
|--------|-------|
| Drift Velocity (violations/turn) | 0.0 |
| Agency Tax (repairs/violation) | 0.0102 |
| Constraint Half-Life (turns) | None |
| Constraint Survival Rate | 0.0 |
| Mode Violation Rate | 0.0397 |
| Repair Success Rate | 0.0 |
| Mean Constraint Lifespan (turns) | 0.0 |
| Mode Entropy | 0.3683 |
| Move Coverage | 0.5053 |

## By Task Stability Class

| Stability Class | N | Drift Vel. | Agency Tax | Half-Life | Survival | Mode Viol. |
|----------------|---|-----------|-----------|----------|----------|-----------|
| Unknown | 2577 | 0.0 | 0.0102 | None | 0.0 | 0.0397 |
